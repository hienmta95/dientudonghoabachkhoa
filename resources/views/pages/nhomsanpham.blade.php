...
<div id="bottom" class="productbreadcrumb" style="height: 50px; margin-bottom: 50px">
  <div class="container">
    ...
    line-height: 20px;">
      ...
      <li>
        <a href="loaisanpham/{{$nhom->loaisukien->id}}/{{$nhom->loaisukien->slug}}.html/#bottom" style="font-size: 16px;">/ {{$nhom->loaisukien->ten}}</a>
      </li>
      <li>
        <a href="nhomsanpham/{{$nhom->id}}/{{$nhom->slug}}.html/#bottom" style="font-size: 16px;">/ {{$nhom->ten}}</a>
      </li>
    </ol>
  </div>
</div>
...
<div class="main1">
  <div class="container">
    <div class="row">
      ...
      @include('menuloaisukien', ['nhom_id' => "$nhom->id", 'loai_id' => "0"])
        ...
        <div class="v2-tabhome">
          <div class="v2-tabhome-title">
            <div class="v2-home-catepr-left-mn">
              <a href="#"><span>Sản phẩm thuộc nhóm {{$nhom->ten}}</span></a>
            </div>
          </div>
